...
public class ABoxFillerTest {
    ...
    private final OWLNamedIndividual startIndividual;
    ...
    public ABoxFillerTest(String concept, String startIndividual, List<String[]> expected) {
        ...
        this.startIndividual = new OWLNamedIndividualImpl(IRI.create(startIndividual));
    ...
    public void checkIndividualAddition() throws FileNotFoundException, OWLOntologyCreationException {
        ...
        List<OWLClass> types = new ArrayList<>();
        types.add(parser.parseOWLClass("http://example.com#A"));
        types.add(parser.parseOWLClass("http://example.com#B"));
        types.add(parser.parseOWLClass("http://example.com#C"));
